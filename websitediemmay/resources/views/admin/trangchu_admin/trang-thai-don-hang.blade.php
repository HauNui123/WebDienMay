...
<div>
    @if ($danhsachhoadon->isEmpty())
        <h1 style="text-align: center; margin-top: 100px;">Không có đơn hàng nào cần cập nhật!</h1>
    @else
        <h2 style="margin: 0; color: RGBA( 135, 206, 235, 1 );">Cập Nhật Đơn Hàng</h2>
        ...
        <form action="{{ route('cap-nhat-trang-thai-don-hang') }}" method="POST">
            @csrf
            ...
            <div class="d-flex justify-content-between" style="margin-top: 10px; margin-bottom: 20px;">
                <button type="submit" class="btn btn-success w-50 me-2" name="action" value="giao-hang-thanh-cong">Giao hàng thành công</button>
                <button type="submit" class="btn btn-danger w-50" name="action" value="giao-hang-that-bai">Giao hàng thất bại</button>
            </div>
        </form>
