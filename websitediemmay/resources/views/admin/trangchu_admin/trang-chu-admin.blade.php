...
<div>
    ...
    <div style="display: flex; align-items: center;">
        ...
        <form id="sortForm" action="{{ isset($loaiSanPham) ? route('trang-chu-admin-theo-loai', ['loaiSanPham' => $loaiSanPham]) : route('trang-chu-admin') }}" method="GET" style="margin-left: auto;display: none; ">
        ...
        <div class="col-md-3 mb-4">
            <div class="card">
                <div class="card" style="height: auto">
                    <div id="carouselExampleControls_{{ $sanpham->MaSP }}" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item  @if($index == 0) active @endif">
                                <!-- <img src="https://firebasestorage.googleapis.com/v0/b/qlsieuthi-54c8e.appspot.com/o/images%2F{{ $hinhanhsp->AnhSanPham }}?alt=media&token=966d606c-9997-467b-8f1f-bcd49b535f5a" class=" d-block w-100 " style="width: 100%; height: 250px; object-fit: cover;" alt="..." /> -->
                                <img src="https://firebasestorage.googleapis.com/v0/b/sieuthidienmay-6e8af.appspot.com/o/images%2F{{ $hinhanhsp->AnhSanPham }}?alt=media&token=4b53c182-5825-47c2-a647-01213a54a87b" class=" d-block w-100 img" style="width: 100%; height: 250px; object-fit: cover;" alt="..." />
                            </div>
                            @endforeach
                        </div>
                    ...
                    <div class="card-body">
                        <h5 class="card-title" style="height: 70px;"><a href="{{ route('san-pham-chi-tiet-admin', $sanpham->MaSP) }}"><?= $sanpham->TenSP ?></a></h5>
                        @if($sanpham->GiaGiam)
                        <p class="card-text">
