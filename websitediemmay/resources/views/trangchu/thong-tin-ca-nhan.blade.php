...
@section('content')
<div>
    <h2 style="margin: 0; color: RGBA( 135, 206, 235, 1 );">Thông Tin Cá Nhân</h2>
    @if(session('success'))
    ...
    <form action="{{ route('cap-nhat-tai-khoan') }}" method="post">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control text-left" id="hoten" name="hoten" value="{{ $khachHang->TenKH}}" style="font-style: italic; font-size: 14px;" required>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control text-left" id="diachi" name="diachi" value="{{ $khachHang->DiaChi}}" style="font-style: italic; font-size: 14px;" required>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="phai" class="form-select form-select-sm">
                        ...
                        <option value="0" {{ $khachHang->GioiTinh == 'Nam' ? 'selected' : '' }}>Nam</option>
                        <option value="1" {{ $khachHang->GioiTinh == 'Nữ' ? 'selected' : '' }}>Nữ</option>
                    </select>
                </div>
                @if ($errors->has('phai'))
            ...
            <div class="col-md-6">
                <label class="form-label" style="text-align:left; display: block;font-family: Verdana, Geneva, Tahoma, sans-serif;"><i class="fas fa-bullseye" style="color: black; font-size: 1.5vw;"></i><strong> Điểm tích lũy</strong></label>
                <input type="text" class="form-control text-left" id="diemtichluy" name="diemtichluy" value="{{ $khachHang->DiemTichLuy}}" style="font-style: italic; font-size: 14px;" readonly>
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                <input type="email" class="form-control text-left" id="email" name="email" value="{{ $khachHang->Email}}" style="font-style: italic; font-size: 14px;" required>
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control text-left" id="sdt" name="sdt" value="{{ $khachHang->SDT}}" style="font-style: italic; font-size: 14px;" required>
            ...
            <div class="col-md-4">
                <div style="position: relative;">
                    <div class="mb-3" style="position: relative;">
                        ...
                        <input type="password" class="form-control" id="password" name="password" value="{{ $khachHang->MatKhau}}" style="font-style: italic; font-size: 14px;" required>
